<template>
    <div class="middle-class-menu-container" >
        ...
        <audio id="select_bisect" src="static/audio/bisect/select_bisect.wav">您的浏览器不支持 audio 标签。</audio>
...
export default {
  ...
  data(){
    return {
        ...
        gameList: [
            {
                title: '请选出二等分的图片',
                leftImg: 'static/images/bisect/bisect.png',
                rightImg: 'static/images/bisect/not_bisect.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
                audioType: 'select_bisect'
            },
            {
                title: '请选出二等分的图片',
                leftImg: 'static/images/bisect/bisect2.png',
                rightImg: 'static/images/bisect/not_bisect2.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
                audioType: 'select_bisect'
            ...
            {
                title: '请选出二等分的图片',
                leftImg: 'static/images/bisect/not_bisect3.png',
                rightImg: 'static/images/bisect/bisect3.png',
                rightChoice: 'right',
                isRight: false,
                isWrong: false,
                audioType: 'select_bisect'
            ...
            {
                title: '请选出二等分的图片',
                leftImg: 'static/images/bisect/bisect4.png',
                rightImg: 'static/images/bisect/not_bisect4.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
                audioType: 'select_bisect'
            ...
            {
                title: '请选出二等分的图片',
                leftImg: 'static/images/bisect/bisect5.png',
                rightImg: 'static/images/bisect/not_bisect5.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
                audioType: 'select_bisect'
  ...
  mounted(){
      ...
      this.$nextTick(()=>{
        ...
        let select_bisect = document.getElementById('select_bisect');
        bg_music.addEventListener("canplaythrough",function(){
            bg_music.play();
        });
        select_bisect.addEventListener("canplaythrough",function(){
            select_bisect.play();
        });
        select_bisect.addEventListener("ended", function(){
