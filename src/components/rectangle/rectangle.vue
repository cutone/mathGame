<template>
    <div class="middle-class-menu-container">
        ...
        <audio id="select_circle" class="stem-music" src="static/audio/rectangle/select_circle.mp3">您的浏览器不支持 audio 标签。</audio>
        <audio id="select_square" class="stem-music" src="static/audio/rectangle/select_square.mp3">您的浏览器不支持 audio 标签。</audio>
        <audio id="select_rectangle" class="stem-music" src="static/audio/rectangle/select_rectangle.mp3">您的浏览器不支持 audio 标签。</audio>
...
export default {
  ...
  data(){
    return {
        completeImg: 'static/images/rectangle/complete.gif',
        currentIndex: 0,
        currentItem: {},
        isFinish: false,
        musicActive: true,
        ...
        gameList: [
            {
                title: '请选出正方形',
                leftImg: 'static/images/rectangle/rectangle_yellow.png',
                rightImg: 'static/images/rectangle/square_green.png',
                rightChoice: 'right',
                isRight: false,
                isWrong: false,
            ...
            {
                title: '请选出三角形',
                leftImg: 'static/images/rectangle/triangle.png',
                rightImg: 'static/images/rectangle/rectangle_green.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
            ...
            {
                title: '请选出圆形',
                leftImg: 'static/images/rectangle/circle.png',
                rightImg: 'static/images/rectangle/football.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
            ...
            {
                title: '请选出长方形',
                leftImg: 'static/images/rectangle/rectangle_green.png',
                rightImg: 'static/images/rectangle/parallelogram.png',
                rightChoice: 'left',
                isRight: false,
                isWrong: false,
            ...
            {
                title: '请选出长方形',
                leftImg: 'static/images/rectangle/pen_box.png',
                rightImg: 'static/images/rectangle/rectangle_red.png',
                rightChoice: 'right',
                isRight: false,
                isWrong: false,
                audioType: 'select_rectangle'
  ...
  mounted(){
      ...
      this.$nextTick(()=>{
        ...
        select_square.addEventListener("canplaythrough",function(){
            select_square.play();
        });        
        //正确提示mp3播放后
