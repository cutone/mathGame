<template>
  <div class="one-and-many-container">
    ...
    <audio id="select_one" class="stem-music" src="static/audio/oneAndMany/select_one.wav">您的浏览器不支持 audio 标签。</audio>
    <audio id="select_many" class="stem-music" src="static/audio/oneAndMany/select_many.wav">您的浏览器不支持 audio 标签。</audio>
    <img
      class="music-img"
      @click="broadcast()"
    ...
    <div v-if="!isFinish" class="body">
      ...
      <img :src="currentItem.one" alt="" class="one-img" :class="'one-img-' + [currentIndex+1]" @click="choose('one', currentItem)">

      <img src="static/images/oneAndMany/tablecloth.png" alt="" class="tablecloth-img" v-if="currentItem.other">


      <div class="many-wrap" :class="'many-wrap-' + [currentIndex+1]" >
        <img v-for="(animal, index) in currentItem.manyList" :key="index" :src="currentItem.many" alt="" class="many-img" :class="animal" @click="choose('many', currentItem)">
      </div>


      <img src="static/images/oneAndMany/submit.png" alt="" class="submit-btn" v-if="currentItem.isRight">
...
.one-and-many-container{
  ...
  .body{
    ...
    background: url('../../../static/images/oneAndMany/background.jpg') no-repeat;
