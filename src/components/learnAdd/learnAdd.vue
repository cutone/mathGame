  ...
  <div class="self-sub-question-within-ten-container">
    ...
    <div v-if="!isFinish" class="body">
        <div class="flex-wrapper question-container">
            <span class="title">看图，列加法算式。</span>
        </div>
        <div class="flex-wrapper middle-container">
            <img :src="'static/images/learnAdd/'+currentItem.questionImg" alt="">
        </div>
        <div class="question-wrapper">
            <div v-for="(item, index) in currentItem.questionList"
                :style="{'background-image':'url(static/images/learnAdd/'+item.background+'.png)'}" 
                :key="index" class="question-item-wrapper">
                <img v-show="item.isRight" :src="'static/images/learnAdd/'+item.currentImg+'.png'" alt="">
            </div>
        </div>
        <div class="flex-wrapper bottom-container">
            <div class="choice-item-wrapper" v-for="(img, index) in currentItem.chioceList" :key="index">
                <img 
                    ...
                    @touchend="check()"
                    :id="img+'_'+index"
                    :src="'static/images/learnAdd/'+img+'.png'" alt="">
            </div> 
        </div>
...
export default {
  ...
  data () {
    ...
    currentItem: {},
      ...
      gameList: [
        {
          questionImg: 'question_1.png',
          chioceList: ['1','2','3','add'],
          isRight: false,
          questionList: [{
          ...
          questionImg: 'question_3.png',
          chioceList: ['3','4','7','add'],
          isRight: false,
          questionList: [{
              background: 'number_box',
              need: '3,4',
